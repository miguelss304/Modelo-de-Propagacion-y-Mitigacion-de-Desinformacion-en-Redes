...
def generate_network(n_nodes, model, seed):
    ...
    if model == "erdos_renyi":
        p = 0.15  # probabilidad de conexión entre cada par de nodos
        ...
        rng = random.Random(seed)  # generador aparte, para no interferir con el seed de networkx
