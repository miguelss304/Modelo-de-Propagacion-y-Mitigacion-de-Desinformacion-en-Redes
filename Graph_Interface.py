...
def run_cascade_with_history(G, seed_nodes, probability, seed):
    """Igual a cascade.run_cascade, pero guarda el estado en cada paso.

    run_cascade solo devuelve el resultado final; para animar necesitamos
    el historial completo paso a paso.

    Args:
        G: grafo sobre el que se simula. Se modifica in-place.
        seed_nodes: nodos que empiezan activados.
        probability: probabilidad de activacion por arista.
        seed: semilla para reproducibilidad.

    Returns:
        historial: lista de sets, historial[t] son los nodos activos
            acumulados hasta el paso t.
    """
